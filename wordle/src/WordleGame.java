...
public class WordleGame {
    ...
    /*
     * Уже выданные автоматические подсказки.
     * Нужны, чтобы подсказки не повторялись.
     */
     ...
     * чтобы можно было заранее задать ответ.
     */
    public WordleGame(
            WordleDictionary dictionary,
            PrintWriter log,
        ...
        String normalized =
                WordleDictionary.normalize(answer);
        ...
        logState(
                "Игра создана с заданным ответом."
        );
    }
    ...
    public String getHint() {
        ...
        /*
         * Убираем слова, которые уже выдавались
         * в качестве автоматической подсказки.
         */
        candidates.removeIf(
                suggestedWords::contains
        );
